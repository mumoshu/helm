...
IMAGE                := ${DOCKER_REGISTRY_PART}${IMAGE_PREFIX}/${SHORT_NAME}:${DOCKER_VERSION}
IMAGE_RUDDER         := ${DOCKER_REGISTRY_PART}${IMAGE_PREFIX}/${SHORT_NAME_RUDDER}:${DOCKER_VERSION}
MUTABLE_IMAGE        := ${DOCKER_REGISTRY_PART}${IMAGE_PREFIX}/${SHORT_NAME}:${MUTABLE_VERSION}
MUTABLE_IMAGE_RUDDER := ${DOCKER_REGISTRY_PART}${IMAGE_PREFIX}/${SHORT_NAME_RUDDER}:${DOCKER_VERSION}
